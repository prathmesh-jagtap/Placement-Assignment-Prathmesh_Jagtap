...
class DataScraper:
            ...
            for row in data_list:
                ...
                for key, value in row.items():
                    ...
                    if isinstance(value, str):
                        # Convert the html text to string
                        value = self.clean_html_tags(value)
                        value = self.convert_to_12_hour_format(
                            value)  # Convert 24 Hour tiem to 12 hour
                    elif isinstance(value, dict):  # It seperate dictionary into string
    ...
    def convert_to_12_hour_format(self, value):
        ...
        if re.match(time_pattern, value):
            ...
            time_12_hour_format = time_obj.strftime('%M:%S')
