...
class Solution1:
    ...
    def counts_word_frequency(self,) -> dict:
        """
...
class TestSolution1(unittest.TestCase):
    ...
    def Test_case1(self):
        s = "Hi, I am Prathmesh Jagtap Jagtap from FSDS batch november 2021. Interest in learning data science, data Analysis, data visualization, \
            data cleaning, data science, and machine learning, deep learning, computer vision."
        lenght = Solution1(s)
        self.assertEqual(lenght.len_max_freq_word(), 4)
    ...
    def Test_case2(self):
        ...
        lenght = Solution1(s)
        self.assertEqual(lenght.len_max_freq_word(), 3)
